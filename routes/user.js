...
router.post("/edit-profile", user_controller.verifyJWT2, user_controller.editProfile);
router.post("/:jwt/edit-picture", user_controller.verifyJWT2, upload.single("picture"), user_controller.editPicture);
router.get("/picture", user_controller.verifyJWT2, user_controller.getPic);
router.post("/change-password", user_controller.verifyJWT2, user_controller.changePassword);
router.post("/delete-account", user_controller.verifyJWT2, bookings_controller.deleteUserBookings, place_controller.removeUnavailableDates, chat_controller.deleteUserChats, user_controller.deleteAccount);

router.post("/:jwt/chat", user_controller.verifyJWT2, chat_controller.getChat);
router.get("/chat-list", user_controller.verifyJWT2, chat_controller.getChatList);
router.get("/:jwt/chat/:id", user_controller.verifyJWT2, chat_controller.chatExists, function(req, res, next) {res.sendFile(path.join(__dirname, '..', 'public', 'views', 'chat.html'));});
router.get("/:jwt/chat/:id/conversation", user_controller.verifyJWT2, chat_controller.getConversation);
router.post("/send-message", user_controller.verifyJWT2, chat_controller.sendMessage);
...
router.get("/bookings-list", user_controller.verifyJWT2, bookings_controller.getBookingsList);
router.post("/delete-booking", user_controller.verifyJWT2, bookings_controller.deleteBooking, place_controller.removeUnavailableDates, function(req, res, next) {res.redirect("back");});
